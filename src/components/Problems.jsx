    ...
    const items = [
        {
            ...
            image: `${baseUrl}/icons/hernia.png`
        },
        {
        ...
        },
        {
            ...
            icon: CustomBone,
            image: `${baseUrl}/icons/injury.png`
        },
        {
            ...
            icon: CustomMomBaby,
            image: `${baseUrl}/icons/mom_baby.png`
        },
        {
            ...
            image: `${baseUrl}/icons/headache.png`
        },
        {
        ...
        },
        {
            ...
            icon: CustomStomach,
            image: `${baseUrl}/icons/stomach.png`
        },
        {
            ...
            image: `${baseUrl}/icons/psychology.png`
        },
        {
